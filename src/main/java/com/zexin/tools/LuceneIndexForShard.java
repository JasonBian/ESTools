...
/**
 * Created by bianzexin on 16/12/21.
 */
public class LuceneIndexForShard {

    private static int QUEUE_SIZE = 1000000;
    private static int FILE_LINE = 10000;
    private static int startShardNum = 1;
    private static int endShardNum = 5;
    ...
    public static MBeanThreadPoolExecutor te = new MBeanThreadPoolExecutor(LuceneIndexForShard.class.getPackage()
            .getName() + ":name=" + LuceneIndexForShard.class.getSimpleName(), Runtime.getRuntime()
            .availableProcessors() * 2, Runtime.getRuntime().availableProcessors() * 2, 10L, TimeUnit.SECONDS,
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for (int i = startShardNum; i < endShardNum; i++) {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    String data = validValueQueue
                            .poll(Long.valueOf(System.getProperty("validValueResponseTime")), TimeUnit.SECONDS);
